...
@Tag(
        ...
        description = "CRUd REST APIs in Eazybank to Create, Read, Update and Delete accounts details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to creaate new Customer and Account inside Eazybank"
    )
    @ApiResponse(
            responseCode = "201",
